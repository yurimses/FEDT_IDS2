...
CONFUSION_MATRIX_MIN_INCH_PER_CLASS = 1.6
...
FIG_DIR = Path("/home/yuri/FEDT_IDS2/figures/best_trees/ML-EdgeIIoT-FEDT/iid-test/")
...
def plot_confusion_matrices_clients(client_files, output_dir: Path):
    ...
    for idx, (cm, label) in enumerate(zip(cms, labels), start=1):
        ...
        ax_i.set_title(label, fontsize=CONFUSION_MATRIX_TITLE_SIZE, fontweight="bold")
        ax_i.set_xlabel("Predicted", fontsize=CONFUSION_MATRIX_AXIS_LABEL_SIZE, fontweight="bold")
        ax_i.set_ylabel("True", fontsize=CONFUSION_MATRIX_AXIS_LABEL_SIZE, fontweight="bold")
        ...
        if class_names is not None:
            ax_i.set_xticklabels(
                ...
                rotation=45,
                ha="right",
                fontsize=CONFUSION_MATRIX_TICK_LABEL_SIZE,
                fontweight="bold",
            )
        ...
        cbar_i.ax.tick_params(labelsize=CONFUSION_MATRIX_COLORBAR_TICK_SIZE)
