...
FIG_DIR = Path("/home/yuri/FEDT_IDS2/figures/best_trees/edgeiot/dominant_client")
...
def _plot_metric_boxplots_clients_by_round(  # [CLASSIF]
    ...
    intervalo de rounds (5 rounds por intervalo):

      - [1–5], [6–10], [11–15], [16–20]

    (assumindo que selected_rounds = [5, 10, 15, 20]).
    ...
    for end_disp in unique_ends:  # [CLASSIF]
        start_disp = max(1, end_disp - 4)  # 5 rounds por intervalo  # [CLASSIF]
...
def plot_f1_and_accuracy_boxplots_clients_by_round(  # [CLASSIF]
    ...
    ambas com 4 subplots (rounds 5, 10, 15, 20) comparando clientes.  # [CLASSIF]
    """  # [CLASSIF]
    _plot_metric_boxplots_clients_by_round(  # [CLASSIF]
        ...
        "f1",
        "F1-score",
        "fig11_f1_clients_box_rounds_5_10_15_20.png",
        output_dir,
    )  # [CLASSIF]
    ...
    _plot_metric_boxplots_clients_by_round(  # [CLASSIF]
        ...
        "acc",
        "Accuracy",
        "fig12_acc_clients_box_rounds_5_10_15_20.png",
        output_dir,
    )  # [CLASSIF]
...
def main():
    ...
    plot_f1_and_accuracy_boxplots_clients_by_round(rounds_data, [5, 10, 15, 20], FIG_DIR)  # [CLASSIF]
